...
<# 
.SYNOPSIS 
    This script will create a bootable USB drive from a ISO file. 
 
.DESCRIPTION 
    This script will create a bootable USB drive from a ISO containing the install bits from a Microsoft operating system. 
...
#> 
    ...
    { 
        ...
        If((Get-Volume | Where-Object DriveType -eq Removable | Select-Object -ExpandProperty DriveLetter) -notcontains $USBDriveLetter) 
        { 
    ...
    {            
        ...
        { 
            ...
            { 
                ...
                $USBDiskNumber = $Disks | Get-Partition | Where-Object DriveLetter -eq $USBDriveLetter | Select-Object -ExpandProperty DiskNumber 
                 
                 
                If(!$USBDiskNumber) 
                { 
                    Write-Verbose "No partitions detected.  USBDiskNumber will be the disk without a partition" 
                    $USBDiskNumber = $Disks | Where-Object NumberOfPartitions -eq 0 | Select-Object -ExpandProperty Number 
                ...
                $USBDiskSize = $Disks | Where-Object Number -eq $USBDiskNumber | Select-Object -ExpandProperty Size 
